...
<body>
    <div class="container">
        <h3 class="text-center">---adaaaaaa---</h3>
        <a href="index.php?mod=category&act=add" class="btn btn-primary">Add To Categories</a>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="index.php?mod=category&act=edit&id=<?= $cate['id'] ?>" class="btn btn-success" style="margin-bottom: 10px;">Edit</a>
